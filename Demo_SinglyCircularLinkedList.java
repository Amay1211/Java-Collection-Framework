...
import Collections.SingleCircularLinkedList;
import java.util.*;

class Demo_SinglyCircularLinkedList
{
	public static void main(String args[]) throws Exception
	{
		...
		SingleCircularLinkedList<Integer> obj = new SingleCircularLinkedList<Integer>();
